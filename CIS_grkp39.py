...
print(f'Linear Regression Test Accuracy for Red Wine: {accuracy_lr_red:.2%}')
print(f'Decision Tree Test Accuracy for Red Wine: {accuracy_dt_red:.2%}')
...
print(f'Linear Regression Test Accuracy for White Wine: {accuracy_lr_white:.2%}')
print(f'Decision Tree Test Accuracy for White Wine: {accuracy_dt_white:.2%}')
